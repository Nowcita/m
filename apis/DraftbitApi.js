...
export const productsGETStatusAndText = (Constants, { limit }) =>
...
export const productsGET = (Constants, { limit }) =>
  productsGETStatusAndText(Constants, { limit }).then(
    ({ status, statusText, text }) => {
      try {
        return JSON.parse(text);
      } catch (e) {
...
export const restaurantsGETStatusAndText = (Constants, { limit }) =>
...
export const restaurantsGET = (Constants, { limit }) =>
  restaurantsGETStatusAndText(Constants, { limit }).then(
    ({ status, statusText, text }) => {
      try {
        return JSON.parse(text);
      } catch (e) {
...
export const teamsGETStatusAndText = Constants =>
...
export const teamsGET = Constants =>
  teamsGETStatusAndText(Constants).then(({ status, statusText, text }) => {
    try {
      return JSON.parse(text);
    } catch (e) {
      console.error(
